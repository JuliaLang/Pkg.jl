...
precompile(Tuple{typeof(Core.Compiler.convert), Type{Type{T} where T}, Type{Tuple{typeof(Base.convert), Type{Union{Nothing, String}}, Nothing}}})
precompile(Tuple{typeof(Core.Compiler.convert), Type{Type{T} where T}, Type{Tuple{typeof(Base.convert), Type{Union{Nothing, String}}, String}}})
...
precompile(Tuple{typeof(Pkg.Types.get_object_branch), LibGit2.GitRepo, String})
