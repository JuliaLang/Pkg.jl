...
function check_package_name(x::String, mode=nothing)
...
add_or_develop(pkgs::Vector{String}; mode::Symbol, kwargs...)            = add_or_develop([check_package_name(pkg, mode) for pkg in pkgs]; mode = mode, kwargs...)
