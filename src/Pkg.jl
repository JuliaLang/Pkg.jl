...
const precompile_script = """
    ...
    precompile(Tuple{Pkg.Artifacts.var"#ensure_artifact_installed##kw",NamedTuple{(:platform,),_A} where _A<:Tuple,typeof(Pkg.Artifacts.ensure_artifact_installed),String,Dict,String})
    precompile(Tuple{Pkg.Artifacts.var"#ensure_artifact_installed##kw",NamedTuple{(:platform,),Tuple{Pkg.BinaryPlatforms.MacOS}},typeof(Pkg.Artifacts.ensure_artifact_installed),String,Dict{String,Any},String})
    precompile(Tuple{Pkg.Artifacts.var"##ensure_artifact_installed#42",Pkg.BinaryPlatforms.Platform,Bool,Bool,typeof(Pkg.Artifacts.ensure_artifact_installed),String,Dict,String})
    precompile(Tuple{Pkg.Artifacts.var"##ensure_artifact_installed#42",Pkg.BinaryPlatforms.Platform,Bool,Bool,typeof(Pkg.Artifacts.ensure_artifact_installed),String,Dict{String,Any},String})
    precompile(Tuple{Pkg.Artifacts.var"##ensure_artifact_installed#42",Pkg.BinaryPlatforms.MacOS,Bool,Bool,typeof(Pkg.Artifacts.ensure_artifact_installed),String,Dict{String,Any},String})
    precompile(Tuple{typeof(Pkg.Artifacts.with_show_download_info),Pkg.Artifacts.var"#44#46"{Bool,Bool,Base.SHA1,_A} where _A,String,Bool}
    precompile(Tuple{Pkg.Artifacts.var"#44#46"{Bool,Bool,Base.SHA1,_A} where _A})
    precompile(Tuple{Pkg.Artifacts.var"#download_artifact##kw",NamedTuple{(:verbose, :quiet_download),Tuple{Bool,Bool}},typeof(Pkg.Artifacts.download_artifact),Base.SHA1,String,Union{Nothing, String}})
    precompile(Tuple{typeof(Pkg.Artifacts.with_show_download_info),Pkg.Artifacts.var"#43#45"{Bool,Bool,Base.SHA1},String,Bool})
    precompile(Tuple{Pkg.Artifacts.var"##download_artifact#38",Bool,Bool,typeof(Pkg.Artifacts.download_artifact),Base.SHA1,String,String})
    precompile(Tuple{typeof(Pkg.Artifacts.create_artifact),Pkg.Artifacts.var"#39#40"{Bool,String,String}})
    precompile(Tuple{Pkg.Artifacts.var"#39#40"{Bool,String,String},String})
    precompile(Tuple{Pkg.PlatformEngines.var"#download_verify_unpack##kw",NamedTuple{(:ignore_existence, :verbose),Tuple{Bool,Bool}},typeof(Pkg.PlatformEngines.download_verify_unpack),String,String,String})
    precompile(Tuple{Pkg.PlatformEngines.var"##download_verify_unpack#106",Nothing,Bool,Bool,Bool,Bool,typeof(Pkg.PlatformEngines.download_verify_unpack),String,String,String})
    precompile(Tuple{Pkg.Artifacts.var"#43#45"{Bool,Bool,Base.SHA1}})
    precompile(Tuple{Pkg.Artifacts.var"#download_artifact##kw",NamedTuple{(:verbose, :quiet_download),Tuple{Bool,Bool}},typeof(Pkg.Artifacts.download_artifact),Base.SHA1,String})
    precompile(Tuple{Pkg.Artifacts.var"#download_artifact##kw",NamedTuple{(:verbose, :quiet_download),Tuple{Bool,Bool}},typeof(Pkg.Artifacts.download_artifact),Base.SHA1,String,Nothing})
    precompile(Tuple{Pkg.Artifacts.var"##download_artifact#38",Bool,Bool,typeof(Pkg.Artifacts.download_artifact),Base.SHA1,String,Nothing})
    precompile(Tuple{typeof(Pkg.Artifacts.create_artifact),Pkg.Artifacts.var"#39#40"{Bool,String,Nothing}})
    precompile(Tuple{Pkg.Artifacts.var"#39#40"{Bool,String,Nothing},String})
    precompile(Tuple{Pkg.PlatformEngines.var"#download_verify_unpack##kw",NamedTuple{(:ignore_existence, :verbose),Tuple{Bool,Bool}},typeof(Pkg.PlatformEngines.download_verify_unpack),String,Nothing,String})
    precompile(Tuple{Pkg.PlatformEngines.var"##download_verify_unpack#106",Nothing,Bool,Bool,Bool,Bool,typeof(Pkg.PlatformEngines.download_verify_unpack),String,Nothing,String})
    precompile(Tuple{Pkg.PlatformEngines.var"#download_verify##kw",NamedTuple{(:force, :verbose, :quiet_download),Tuple{Bool,Bool,Bool}},typeof(Pkg.PlatformEngines.download_verify),String,String,String})
    precompile(Tuple{Pkg.PlatformEngines.var"##download_verify#93",Bool,Bool,Bool,typeof(Pkg.PlatformEngines.download_verify),String,String,String})
    precompile(Tuple{Pkg.PlatformEngines.var"#download_verify##kw",NamedTuple{(:force, :verbose, :quiet_download),Tuple{Bool,Bool,Bool}},typeof(Pkg.PlatformEngines.download_verify),String,Nothing,String})
    precompile(Tuple{Pkg.PlatformEngines.var"##download_verify#93",Bool,Bool,Bool,typeof(Pkg.PlatformEngines.download_verify),String,Nothing,String})
    precompile(Tuple{Pkg.PlatformEngines.var"#download##kw",NamedTuple{(:verbose,),Tuple{Bool}},typeof(Pkg.PlatformEngines.download),String,String})
    precompile(Tuple{Pkg.PlatformEngines.var"##download#92",Bool,Nothing,typeof(Pkg.PlatformEngines.download),String,String})
    precompile(Tuple{Pkg.PlatformEngines.var"##handle_auth_error#77",Bool,typeof(Pkg.PlatformEngines.handle_auth_error),String,String})
    precompile(Tuple{Pkg.PlatformEngines.var"#get_auth_header##kw",NamedTuple{(:verbose,),Tuple{Bool}},typeof(Pkg.PlatformEngines.get_auth_header),String})
    ...
    precompile(Tuple{Pkg.PlatformEngines.var"##get_auth_header#82",Bool,typeof(Pkg.PlatformEngines.get_auth_header),String})
    precompile(Tuple{typeof(Pkg.PlatformEngines.load_telemetry_file),String})
    precompile(Tuple{Type{Dict{Pkg.BinaryPlatforms.Platform,Dict{String,Any}}},Base.Generator{Array{Dict{String,Any},1},Pkg.Artifacts.var"#21#22"{String,String}}})
    precompile(Tuple{Pkg.PlatformEngines.var"#unpack##kw",NamedTuple{(:verbose,),Tuple{Bool}},typeof(Pkg.PlatformEngines.unpack),String,String})
    precompile(Tuple{Pkg.PlatformEngines.var"##unpack#101",Bool,typeof(Pkg.PlatformEngines.unpack),String,String})
    precompile(Tuple{typeof(iterate),Base.Generator{Array{Dict{String,Any},1},Pkg.Artifacts.var"#21#22"{String,String}}})
    precompile(Tuple{typeof(iterate),Base.Generator{Array{Dict{String,Any},1},Pkg.Artifacts.var"#21#22"{String,String}},Int64})
    precompile(Tuple{Pkg.Artifacts.var"#21#22"{String,String},Dict{String,Any}})
    precompile(Tuple{typeof(Pkg.Artifacts.unpack_platform),Dict{String,Any},String,String})
    precompile(Tuple{Pkg.Artifacts.var"##query_override#7",Dict{Symbol,Dict},typeof(Pkg.Artifacts.query_override),Base.SHA1})"""
