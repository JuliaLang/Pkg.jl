...
"""
    Pkg.precompile(; strict::Bool=false, timing::Bool=false, skip_dependents::Bool=true, force::Bool=false, force_stdlibs::Bool=false)
    Pkg.precompile(pkg; strict::Bool=false, timing::Bool=false, skip_dependents::Bool=true, force::Bool=false, force_stdlibs::Bool=false)
    Pkg.precompile(pkgs; strict::Bool=false, timing::Bool=false, skip_dependents::Bool=true, force::Bool=false, force_stdlibs::Bool=false)
...
already up to date. Standard libraries are left alone unless `force_stdlibs=true`
(`pkg> precompile --forceall`).
...
!!! compat "Julia 1.14"
    `skip_dependents`, `force` and `force_stdlibs` require at least Julia 1.14.
