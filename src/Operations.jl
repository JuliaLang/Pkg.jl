...
function is_package_downloaded(ctx, pkg::PackageSpec)
    ...
    (sourcepath === nothing) && pkgerror("It looks like your manifest file was generated by a different version of Julia and thus is not compatible with this version of Julia")
