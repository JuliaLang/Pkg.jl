...
function load_urls(ctx::Context, pkgs::Vector{PackageSpec})
    ...
    for pkg in pkgs
        uuid = pkg.uuid
        pkg.version isa VersionNumber || throw(ErrorException("The manifest file you are using was generated by a different version of Julia and is not compatible with this Julia version"))
