...
const STDLIBS_BY_VERSION = [
    ...
    v"1.8.0" => Dict{UUID,Tuple{String,Union{VersionNumber,Nothing}}}(
        ...
        UUID("deac9b47-8bc7-5906-a0fe-35ac56dc84c0") => ("LibCURL_jll", v"7.83.1+1"),
        UUID("76f85450-5226-5b5a-8eaa-529ad045b433") => ("LibGit2", nothing),
        ...
        UUID("83775a58-1f1d-513f-b197-d71354ab007a") => ("Zlib_jll", v"1.2.12+3"),
        UUID("05ff407c-b0c1-5878-9df8-858cc2e60c36") => ("dSFMT_jll", v"2.2.4+1"),
        UUID("8f36deef-c2a5-5394-99ed-8e07531fb29a") => ("libLLVM_jll", v"13.0.1+2"),
        UUID("8e850b90-86db-534c-a0d3-1478176c7d93") => ("libblastrampoline_jll", v"5.1.1+0"),
        UUID("8e850ede-7688-5339-a07c-302acd2aaf8d") => ("nghttp2_jll", v"1.47.0+0"),
        UUID("3f19e933-33d8-53b3-aaab-bd5110c3b7a0") => ("p7zip_jll", v"17.4.0+0"),
    ),
    v"1.9.0" => Dict{UUID,Tuple{String,Union{VersionNumber,Nothing}}}(
        ...
        UUID("e66e0078-7015-5450-92f7-15fbd957f2ae") => ("CompilerSupportLibraries_jll", v"0.5.2+0"),
        UUID("ade2ca70-3891-5945-98fb-dc099432e06a") => ("Dates", nothing),
        UUID("8bb1440f-4735-579b-a4ab-409b98df4dab") => ("DelimitedFiles", v"1.0.0"),
        UUID("8ba89e20-285c-5b6f-9357-94700520ee1b") => ("Distributed", nothing),
        UUID("f43a241f-c20a-4ad4-852c-f6b1247861c6") => ("Downloads", v"1.6.0"),
        UUID("7b1f6079-737a-58dc-b8bc-7a2ca5c1b5ee") => ("FileWatching", nothing),
        UUID("9fa8497b-333b-5362-9e8d-4d0656e87820") => ("Future", nothing),
        ...
        UUID("29816b5a-b9ab-546f-933c-edad1886dfa8") => ("LibSSH2_jll", v"1.10.2+0"),
        UUID("183b4373-6708-53ba-ad28-60e28bb38547") => ("LibUV_jll", v"2.0.1+8"),
        ...
        UUID("83775a58-1f1d-513f-b197-d71354ab007a") => ("Zlib_jll", v"1.2.12+3"),
        UUID("05ff407c-b0c1-5878-9df8-858cc2e60c36") => ("dSFMT_jll", v"2.2.4+1"),
        UUID("8f36deef-c2a5-5394-99ed-8e07531fb29a") => ("libLLVM_jll", v"14.0.5+3"),
        UUID("8e850b90-86db-534c-a0d3-1478176c7d93") => ("libblastrampoline_jll", v"5.1.1+0"),
