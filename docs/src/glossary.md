...
In the future, it may become possible for an application to provide global configuration options for packages it
depends on. Packages, on the other hand, will not be able to provide global configuration for their dependencies
