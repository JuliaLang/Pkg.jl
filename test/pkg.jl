...
@testset "semver notation" begin
    @test semver_spec("^1.2.3") == VersionSpec("1.2.3+0-1")
    @test semver_spec("^1.2")   == VersionSpec("1.2.0+0-1")
    @test semver_spec("^1")     == VersionSpec("1.0.0+0-1") == VersionSpec("1.0.0-1")
    @test semver_spec("^0.2.3") == VersionSpec("0.2.3+0-0.2")
    @test semver_spec("^0.0.3") == VersionSpec("0.0.3+0-0.0.3") == VersionSpec("0.0.3-0.0.3")
    @test semver_spec("^0.0")   == VersionSpec("0.0.0-0.0") == VersionSpec("0.0.0+0-0.0")
    @test semver_spec("^0")     == VersionSpec("0.0.0+0-0") == VersionSpec("0.0.0-0")
    @test semver_spec("~1.2.3") == VersionSpec("1.2.3+0-1.2")
    ...
    @test semver_spec("0.0.3, 1.2") == VersionSpec(["0.0.3-0.0.3", "1.2.0+0-1"])
    ...
    @test semver_spec("<1.2.3") == VersionSpec("0.0.0+0 - 1.2.2")
    @test semver_spec("<1.2") == VersionSpec("0.0.0+0 - 1.1")
    @test semver_spec("<1") == VersionSpec("0.0.0 - 0")
    @test semver_spec("<2") == VersionSpec("0.0.0+0 - 1")
    @test semver_spec("<0.2.3") == VersionSpec("0.0.0+0 - 0.2.2")
    @test semver_spec("<2.0.3") == VersionSpec("0.0.0+0 - 2.0.2")
    @test   v"0.2.3" in semver_spec("<0.2.4")
    @test !(v"0.2.4" in semver_spec("<0.2.4"))

    @test semver_spec("=1.2.3") == VersionSpec("1.2.3+0")
    @test semver_spec("=1.2") == VersionSpec("1.2.0+0")
    @test semver_spec("  =1") == VersionSpec("1.0.0+0")
    @test   v"1.2.3" in semver_spec("=1.2.3")
    ...
    @test semver_spec("0.1.0 - 0.2.2, 1.2") == VersionSpec(["0.1.0 - 0.2.2", "1.2.0+0-1"])
    @test semver_spec("0.1.0 - 0.2.2, >=1.2") == VersionSpec(["0.1.0 - 0.2.2", "1.2.0+0-*"])
