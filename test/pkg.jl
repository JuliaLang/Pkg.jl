...
@testset "Pkg.Types._is_dev_version" begin
    @test !Pkg.Types._is_dev_version(v"1.2.3")
    @test Pkg.Types._is_dev_version(v"1.2.3-DEV")
    @test Pkg.Types._is_dev_version(v"1.2.3-DEV.456")
end

@testset "Pkg.Types._prune_dev_version" begin
    @test Pkg.Types._prune_dev_version(v"1.2.3") == v"1.2.3"
    @test Pkg.Types._prune_dev_version(v"1.2.3-DEV") == v"1.2.3-DEV"
    @test Pkg.Types._prune_dev_version(v"1.2.3-DEV.456") == v"1.2.3-DEV"
end

@testset "Pkg.Types._generated_by_julia" begin
    @test Pkg.Types._generated_by_julia(v"1.2.3") == "# Generated by Julia version 1.2.3\n\n"
    @test Pkg.Types._generated_by_julia(v"1.2.3-DEV") == "# Generated by Julia version 1.2.3-DEV\n\n"
    @test Pkg.Types._generated_by_julia(v"1.2.3-DEV.456") == "# Generated by Julia version 1.2.3-DEV\n\n"
end
