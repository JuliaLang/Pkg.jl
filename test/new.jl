                ...
                with_current_env() do
                    ...
                    @testset "JULIA_NUM_THREADS=other_nthreads_default" begin
                        withenv(
                            ...
                            "EXPECTED_NUM_THREADS_INTERACTIVE" => "$default_nthreads_interactive",
                            "JULIA_NUM_THREADS" => "$other_nthreads_default,$default_nthreads_interactive",
                        ) do
                            Pkg.test("TestThreads")
                        end
                    end
                    ...
                    @testset "--threads=other_nthreads_default" begin
                        withenv(
                            ...
                            Pkg.test("TestThreads"; julia_args=`--threads=$other_nthreads_default,$default_nthreads_interactive`)
                        end
                    end
